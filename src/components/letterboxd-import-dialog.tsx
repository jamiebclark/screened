        ...
        {phase === "input" && (
          <form onSubmit={handleSubmit} className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Paste a public Letterboxd list, watchlist, or films page URL.
              Films will be looked up on TMDB and added to this list.
            </p>
            ...
            <p className="text-xs text-muted-foreground">
              ...
              <code className="text-xs">
                letterboxd.com/username/list/list-name/
              </code>
              <br />
              <code className="text-xs">
          ...
          <div className="flex flex-col items-center gap-4 py-8">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Fetching each film from Letterboxd and matching to TMDB. This
                may take a moment for longer lists.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="space-y-4">
            ...
            {result.added > 0 && (
              <div className="flex items-center gap-2 text-sm text-green-400">
                ...
                Successfully imported {result.added} film
                {result.added !== 1 ? "s" : ""} into the list.
              </div>
            )}
