...
- **Collaborative lists** — shared watchlists with member invites and three visibility tiers (public link for anyone, site members, or private), a watch timeline of when each title was seen, and a live Radarr endpoint per list for home media server users
